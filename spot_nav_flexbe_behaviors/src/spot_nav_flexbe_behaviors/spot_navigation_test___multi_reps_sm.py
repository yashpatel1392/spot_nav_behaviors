...
@author: Yash P
'''
class SpotNavigationTestMultiRepsSM(Behavior):
	'''
	...
	def __init__(self):
		super(SpotNavigationTestMultiRepsSM, self).__init__()
		self.name = 'Spot Navigation Test - Multi Reps'
	...
	def create(self):
		...
		with _sm_container_0:
			...
			OperatableStateMachine.add('CounterCheck',
										...
										transitions={'success': 'Pause1', 'failed': 'failed', 'end': 'finished'},
			...
			OperatableStateMachine.add('NavigateToDest',
										...
										transitions={'continue': 'Pause2', 'failed': 'failed'},
			...
			OperatableStateMachine.add('Pause1',
										...
										transitions={'success': 'NavigateToDest'},
										autonomy={'success': Autonomy.Off})

			# x:776 y:252
			OperatableStateMachine.add('Pause2',
										PauseState(topic=self.pause_topic),
										transitions={'success': 'NavigateToStartPos'},
										autonomy={'success': Autonomy.Off})
