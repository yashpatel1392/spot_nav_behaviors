...
@author: Yash P
'''
class SwapLeaseTestv4SM(Behavior):
	'''
	Swap Lease Test v4
	'''
	...
	def __init__(self):
		super(SwapLeaseTestv4SM, self).__init__()
		self.name = 'Swap Lease Test v4'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Setup',
										SetupSpot(),
										transitions={'continue': 'GetArmData', 'failed': 'failed'},
			...
			# x:516 y:142
			OperatableStateMachine.add('GetArmData',
										GetArmData(),
